# NobleCause SOL build

Statischer, datengetriebener Startseiten-Prototyp nach dem Bauauftrag vom 14.07.2026.
...
`build.py` validiert `data/sitzung.json` gegen `schema/sitzung.schema.json` und erzeugt `index.html`. Das Ergebnis enthält bereits alle wichtigen Inhalte. JavaScript ist nur eine Verbesserung für die Protokoll-Reiter und die Tastatursteuerung.
