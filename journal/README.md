...
Beispiele:
- `2026-07-08/` regulärer Lauf
- `2026-07-08b/` Steward-Eintrag
- `2026-07-08c/` Vertretungslauf (Kimi K2)
...
| `deputation_note` | string \| null | optionale wörtliche Vertretungs-Deklaration |
...
Sonderfälle im Feld:
- **Steward-Eintrag:** `convene: true`, häufig `model: null`, Kosten können `0` sein.
- **Vertretungslauf:** anderes Modell als Fable (z. B. `kimi-k2`),
  `deputation_note` gesetzt, Kosten können unbekannt sein (`costs.total: null`).
