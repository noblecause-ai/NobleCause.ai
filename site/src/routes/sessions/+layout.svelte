<script>
	// Protokoll-Explorer — gemeinsame Gestalt für /sessions und /sessions/[id]
	...
	// Rahmung, Vignetten und Hairlines statt Boxen, die Medaillons ordnen die
	// Voten. Deutsch-only (der Rekord).
	let { children } = $props();
</script>
...
<style>
	...
	/* ---- Bereichszeilen (kein Kasten, Hairline-getrennt) -------------------- */
	...
	/* Modelle ohne Medaillon (frühere Sitzungen): der Namensplatz bleibt bündig. */
	...
	/* ---- Aufklapper (Wortlaut/Selbstdarstellung) — Hairline, kein Kärtchen --- */
	...
	/* ---- Wortlaut-Fließtext (ungekürzt, gerendertes Markdown) ---------------- */
