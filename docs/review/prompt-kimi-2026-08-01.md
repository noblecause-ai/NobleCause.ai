> **Kontext:** Zwei Reviews laufen gleichzeitig und **blind gegeneinander** — du siehst den Bericht des anderen nicht und fragst nicht danach. **Frische Session, kein Vorkontext:** wer seine eigene Baugeschichte im Kopf hat, prüft seine Erinnerung statt den Code. Du bist **Kimi 3**.
...
- Worktree: `../nc-review-kimi` — **arbeite nur dort**, nicht im Hauptbaum
